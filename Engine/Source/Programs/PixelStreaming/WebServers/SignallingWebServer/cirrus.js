...
var clientConfig = { type: 'config', peerConnectionOptions: {}, unrealVersion: 4.27};
...
try {
	...
	if (typeof config.unrealVersion != 'undefined'){
		clientConfig.unrealVersion = config.unrealVersion;
	}
